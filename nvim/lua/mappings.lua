...
map("n", "<leader>ca", "<cmd>CompetiTest add_testcase<CR>", { desc = "CP: Add testcase" })
map("n", "<leader>ce", "<cmd>CompetiTest edit_testcase<CR>", { desc = "CP: Edit testcase" })
map("n", "<leader>cd", "<cmd>CompetiTest delete_testcase<CR>", { desc = "CP: Delete testcase" })
map("n", "<leader>cu", "<cmd>CompetiTest show_ui<CR>", { desc = "CP: Show UI" })
map("n", "<leader>cp", "<cmd>CompetiTest receive problem<CR>", { desc = "CP: Receive problem" })
map("n", "<leader>cC", "<cmd>CompetiTest receive contest<CR>", { desc = "CP: Receive contest" })
map("n", "<leader>ct", "<cmd>CompetiTest receive testcases<CR>", { desc = "CP: Receive testcases" })
